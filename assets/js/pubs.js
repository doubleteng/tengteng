...
`@article{kong2019micro,
  ...
  author={Kong, Meng and Zhang, Jianshun and Dang, Thong Q and Hedge, Alan and {\b Teng Teng} and Carter, Brian and Chianese, Chetna and Khalifa, H Ezzat},
...
author = {Zhi, Yefan and {\b Teng Teng} and Akbarzadeh, Masoud},
year = {2024},
month = aug,
...
author = {{\b Teng Teng} and Yefan Zhi and Masoud Akbarzadeh},
...
`@article{zhi2024automated,
  ...
  author={Zhi, Yefan and Chai, Hua and {\b Teng Teng} and Akbarzadeh, Masoud},
...
author = {Creston A. Singer and Hajara Abdul-Karim and Kyle Printon and Nagireddy Poluri and {\b Teng Teng} and Mostafa Akbari and Behzad Modanloo and Laia Mogas-Soldevila and Masoud Akbarzadeh and Xiao Hu and Sean M. O'Malley and Hong Fang and David Salas-de {la Cruz}},
...
`@article{yu20253d,
  ...
  author={Yu, Kun-Hao and {\b Teng Teng} and Nah, So Hee and Chai, Hua and Zhi, Yefan and Wang, Kun-Yu and Chi, Yinding and Psarras, Peter and Akbarzadeh, Masoud and Yang, Shu},
...
`@article{birol2024robosense,
  ...
  author={Birol, Eda Begum and {\b Teng Teng} and Moghadashi, Mahshid and Asgari, Alexia and Guo, Kevin  and Piorko, Karolina and Varga, Veronika and Sabin, Jenny E.},
...
`@inproceedings{teng2024gradient,
  ...
  author={{\b Teng Teng} and Zhi, Yefan and Akbarzadeh, Masoud},
...
`@inproceedings{akbarzadeh2024fabricate,
  ...
  author={Masoud Akbarzadeh and Hua Chai and Yefan Zhi and Maximilian E. Ororbia and {\b Teng Teng} and Mathias Bernhard and Damon (Mohammad) Bolhassani and Fahimeh Yavartanoo and Javier Tapia and Karolina Pajak and Mylène Bernard and Leon Trousset and Paul Kassabian and Blaise Waligun},
...
`@inproceedings{Teng-2023-Multi-material_Truss,
  ...
  author={{\b Teng Teng} and Zhi, Yefan and Yu, Kun-Hao and Yang, Shu and Akbarzadeh, Masoud},
  year={2023},
  month={July 10-14},
...
`@inproceedings{teng2021design,
  ...
  author={{\b Teng Teng} and Sabin, Jenny},
...
`@inproceedings{teng2020scutoid,
  ...
  author={{\b Teng Teng} and Jia, Mian and Sabin, Jenny},
...
`@inproceedings{teng2017integrated,
  ...
  author={{\b Teng Teng} and Li, Qinying},
...
`@inproceedings{teng2015transformable,
  ...
  author={{\b Teng Teng} and Johnson, Brian R.},
...
`@incollection{teng2025funicular,
  author    = {{\b Teng Teng} and Zhi, Yefan and Shao, Yiliang and Ororbia, Maximilian E. },
